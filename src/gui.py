...
from simulation.intelligence.male_ai import move as male_move, action as male_action,check_color_and_adjust as male_check_color_and_adjust
from simulation.intelligence.soldier_ai import move as soldier_move, action as soldier_action,check_color_and_adjust as soldier_check_color_and_adjust
import random
